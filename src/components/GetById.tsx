    ...
    return (
        <div className="form-row">
            <div className="col-md-8 mb-3">
                <h1 style={{color:"black"}}> Item Info </h1>
                ...
                {reservation && (
                    <div>
                        <div key={reservation.id}>
                            ...
                            <h5 style={{color: "#fff", fontSize: "20px",  marginTop: "3%"}}>Delivery Id Number: {reservation.delivery?.id}</h5>
                            ...
                            <h6>Product</h6>
                            <h5 style={{color: "#fff", fontSize: "20px",marginTop: "3%"}}>Product Id Number: {reservation.product?.id}</h5>
